...
import { saveOrder, OrderDetails, OrderItem } from '@/lib/razorpay';
...
export default function Checkout() {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      // Razorpay options
      const options = {
        key: process.env.VITE_RAZORPAY_KEY_ID || 'rzp_test_1DP5mmOlF5G5ag', // Replace with your actual key
        amount: totalPrice * 100, // Amount in paise
        currency: 'INR',
        name: 'Jharkhand Explorer',
        description: `Order for ${items.length} item(s)`,
        image: '/src/assets/Logo.jpg',
        order_id: '', // Will be generated by Razorpay
